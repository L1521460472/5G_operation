        ...
        <el-tab-pane label="发送记录" name="first">
          <div class="headerBtn">
            ...
            <div class="headerBtnLeft">
              ...
              <el-select v-model="sendStatus" placeholder="状态" size="small" ref="statusSelect" @visible-change="statusChange" clearable style="margin-right:10px" @change="getSendBatchList">
            ...
            <div class="headerBtnRight">
              <el-button size="small" class=" iconBtn active" style="margin-right:3px" @click="exportRepeat" v-has="'messageAllBatchMessageExport'">
            ...
            <el-table border size="small" tooltip-effect="dark" v-loading="loading1" :data="sendData" :style="{'color':'#333','min-height': (minHeight || '') + 'px'}"
              ...
              <el-table-column label="操作" width="80" fixed="right">
                <template slot-scope="scope">
                  ...
                  <span class="operation" v-has="'messageAllSendRecordPageList'" @click="toDetail(scope)">发送详情</span>
                  <!-- <el-tooltip class="item" effect="dark" content="发送详情" placement="top">
                    <img class="operation" src="../../assets/images/icon_24px_more.svg" v-has="'messageAllSendRecordPageList'" @click="toDetail(scope)">
                  </el-tooltip> -->
                </template>
              </el-table-column>
            </el-table>
        ...
        <el-tab-pane label="发送详情" name="second">
          <div class="headerBtn">
            ...
            <div class="headerBtnLeft">
              ...
              <el-select v-model="status2" placeholder="状态" size="small" ref="statusSelect2" @visible-change="statusSelect2" clearable style="margin-right:10px" @change="getSendDetail">
        ...
        <el-tab-pane label="接收记录" name="third">
          <div class="headerBtn">
            ...
            <div class="headerBtnLeft">
              ...
              <el-select v-model="enterpriseAccountAppId3" placeholder="应用" size="small" ref="appSelect" @visible-change="appChange" clearable @change="getReceiveList">
                <el-option v-for="item in appOptions" :key="item.id" :label="item.name" :value="item.id">
                </el-option>
              </el-select>
              <el-select v-model="status3" placeholder="状态" size="small" ref="statusSelect" @visible-change="statusChange" @change="getReceiveList" clearable style="margin-right:10px">
              ...
              <el-table border size="small" v-loading="loading3" tooltip-effect="dark" :data="receiveData" :style="{'color':'#333','min-height': (minHeight || '') + 'px'}"
                ...
                <el-table-column label="操作">
                  <template slot-scope="scope">
                    ...
                    <span class="operation" v-has="'messageRecordAllView'" @click="handleDetails(scope.$index, scope.row)">查看记录</span>
                    <!-- <el-tooltip class="item" effect="dark" content="查看记录" placement="top">
                      <img class="operation" src="../../assets/images/icon_24px_detail.svg" v-has="'messageRecordAllView'" @click="handleDetails(scope.$index, scope.row)" />
                    </el-tooltip> -->
                  </template>
                </el-table-column>
              </el-table>
...
import { sendBatch, sendDetailList, receiveList, recoedDetail, exportExcel } from '../../api/message/message'
...
export default {
  ...
  methods: {
    ...
    // 获取业务类型
    getMessageTypeList() {
      getBusinessTypeList({id: 1}).then(res => {
        if (res.status == 0) {
          console.log(res)
