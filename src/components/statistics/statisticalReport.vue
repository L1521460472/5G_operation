    ...
    <div class="header">
      ...
      <div class="nav">
        <el-button-group>
          ...
          <el-button size="small" @click="btn(2)">近一周</el-button>
          <el-button size="small" @click="btn(3)">近30天</el-button>
        </el-button-group>
      ...
      <div class="list">
        <div class="listBox">
          <div class="listBoxLeft">
            <img src="../../assets/images/icon_28px_总提交2.0.svg" alt="">
          </div>
        ...
        <div class="listBox">
          <div class="listBoxLeft">
            <img src="../../assets/images/icon_28px_总发送2.0.svg" alt="">
          </div>
          <div class="listBoxRight">
            <p>{{ total2 }}</p>
            <span>总发送量
        ...
        <div class="listBox">
          <div class="listBoxLeft">
            <img src="../../assets/images/icon_28px_总成功2.0.svg" alt="">
          </div>
          <div class="listBoxRight">
            <p>{{ total3 }}</p>
            <span>总成功量
        ...
        <div class="listBox">
          <div class="listBoxLeft">
            <img src="../../assets/images/icon_28px_总接收2.0.svg" alt="">
          </div>
          <div class="listBoxRight">
            <p>{{ total4 }}</p>
            <span>总接收量
        ...
        <div class="listBox">
          <div class="listBoxLeft">
            <img src="../../assets/images/icon_28px_成功率2.0.svg" alt="">
          </div>
          <div class="listBoxRight">
            <p>{{ total5 }}</p>
            <span>成功率
  ...
  data() {
    return {
      ...
      tableDataLabel: [
        ...
        { label: '企业名称', disabled: false, width: '120', prop: 'enterpriseAccountId' },
        ...
        { label: '平均发送时长', disabled: true, width: '100', prop: 'avgSendTime' },
        { label: '最大发送时长', disabled: true, width: '100', prop: 'maxSendTime' },
        { label: '平均送达时长', disabled: true, width: '100', prop: 'avgDeliveryTime' },
        { label: '最大送达时长', disabled: true, width: '100', prop: 'maxDeliveryTime' },
      ],
    }
  },
  methods: {
    ...
    handleTypeList() {
      ...
      if (this.value2 == 'TOTAL') {
        ...
        this.disabled = false
        this.initTotal()
      } else if (this.value2 == 'ENTERPRISE_ACCOUNT') {
        this.tableDataLabel[1].disabled = true
        this.disabled = true
        this.text = '企业'
        account().then((res) => {
          this.options3 = res.data
          this.options3.unshift({ id: '', name: '全部企业' })
        })
        this.initTotal()
      }
    },
    ...
    initTotal() {
      reportTotal({
        ...
        .then((res) => {
            ...
            this.total1 = res.data.totalSubmit
            ...
            this.tableData = res.data.dailyReportStatistics.map((item) => {
              ...
              if (item.enterpriseAccountId == null) {
                item.enterpriseAccountId = '全部'
              }
              if (this.value2 == 'ENTERPRISE_ACCOUNT') {
                this.options3.map((res) => {
                  if (item.enterpriseAccountId == res.id) {
                    item.enterpriseAccountId = res.name
                  }
                })
              }
