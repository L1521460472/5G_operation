                ...
                <el-collapse :value="activeNames" >
                  <el-collapse-item title="基本信息"  name="1" v-if="props.row.baseInfo">
                    ...
                    <div class="separate">
                      ...
                      <div class="cont"><span class="lable">内容最大值(kb)：</span>{{props.row.baseInfo.contentMaxSize}}</div>
                    </div>
                    <div class="separate">
    ...
    <el-drawer
      ...
      >
        <el-collapse v-model="drawerActive" >
          <el-collapse-item title="基本信息" name="baseInfo">
            ...
            <el-form-item prop="channelAccount" label="通道账号：">
              <el-input class="limitWord" size="small" maxlength="50" show-word-limit v-model="channelForm.channelAccount" oninput="value=value.replace(/[\u4e00-\u9fa5]/ig,'')"></el-input>
            </el-form-item>
            <el-form-item prop="channelPassword" label="通道密码：">
              <el-input class="limitWord" size="small" maxlength="20" show-word-limit v-model="channelForm.channelPassword" oninput="value=value.replace(/[\u4e00-\u9fa5]/ig,'')"></el-input>
            </el-form-item>
            ...
            <el-form-item prop="serviceCode" label="服务代码：">
              <el-input class="limitWord" size="small" maxlength="20" :disabled="disEdit" show-word-limit v-model="channelForm.serviceCode"  oninput="value=value.replace(/[^\d]/g,'')" @blur="channelForm.serviceCode = $event.target.value"></el-input>
            </el-form-item>  
            ...
            <el-form-item prop="maxWord" label="内容最大值(kb)：">
        ...
        <el-form-item prop="parmentDepartment" label="">
          ...
          <!-- <el-button  type="primary" size="small" @click="disEdit ? editConfirm():addConfirm()">提交</el-button> -->
...
<script>
import {getVmsChannelDetail,addChannel,editChannel,disableChannel,enableChannel,copyChannel,getSupplierList} from '../../api/channel/api'
...
export default {
  ...
  methods: {
    ...
    handleExpand(row,expandedRows){
      getVmsChannelDetail({id:row.id}).then(res=>{
        if(res.status == 0){
    ...
    createAction(){
      ...
      this.channelForm.maxWord = 2000,//内容最大值
        ...
        if(valid){
          ...
          this.timer = setTimeout(function () {
            ...
            let params ={
              ...
              contentMaxSize:_this.channelForm.maxWord,
    ...
    changeAction(row){
      ...
      getVmsChannelDetail({id:row.id}).then(res=>{
        if(res.status == 0){
          ...
          this.channelForm.maxWord =res.data.baseInfo.contentMaxSize,
      ...
      this.$refs.channelForm.validate((valid)=>{
        if(valid){
          let params = {
              ...
              contentMaxSize:this.channelForm.maxWord,
